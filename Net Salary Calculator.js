...
function calculateNetSalary(basicSalary, benefits) {
    ...
    // Output results console.log(Gross Salary: ${grossSalary});
...
calculateNetSalary(50000, 10000); // Change inputs to test with different salaries console.log(Gross Salary: ${grossSalary});